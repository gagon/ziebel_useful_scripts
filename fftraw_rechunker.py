...
fftrawout_file =  '/mnt/A3-Data1/Data/CoP/A-05/DAS/fft_test/proc1/2014.08.18.09.33.21.hdf'
rechunked_file =  '/mnt/A3-Data1/Data/CoP/A-05/DAS/fft_test/proc1/2014.08.18.09.33.21.hdf_rechunked2.hdf'
...
time_chunk_size=1199
depth_chunk_size=7835
freq_chunk_size=10
        ...
        for y in range(total_y_chunks):                                      
            ...
            for z in range(total_z_chunks):                                      
                ...
                if ds_cnt==0:
                    ...
                    rechunked_hdf['/data'].resize(original_hdf['data'].shape)
                else:                    
